...
// implements the alpha beta pruning strategy for the minmax algorithm
// to retrive the least loss state on the board
...
public class AlphaBetaWithMoveOrdering extends Observable implements MoveStrategy {
    ...
    private enum MoveSorter {
        // used to to sort the moves using smart sort
        SORT {
            @Override
        ...
        // used to sort the moves based on the available 
        // Attacking moves, castling moves, then non-attacking moves 
        //involving high value pieces
