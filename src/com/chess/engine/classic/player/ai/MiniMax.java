...
// used to implement the min max algorithm
public final class MiniMax implements MoveStrategy {
    ...
    // this methods executes the min max algorithm
    ...
    // these are the co-recursive min max methods 
    //for calculating the min loss and max profit
    ...
    // used to check whether the game is at the end
