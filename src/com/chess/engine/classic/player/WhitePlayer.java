...
// This class is used to represent the white player of the chess game board
public final class WhitePlayer extends Player {
    ...
    // used to calculate the castle moves possible to make by white player, if exists
    @Override
    ...
    // used to get the opponent of the white player
    @Override
    public BlackPlayer getOpponent() {
        return this.board.blackPlayer();
    }
    // used to get the Active Pieces of the white player
    @Override
    public Collection<Piece> getActivePieces() {
        return this.board.getWhitePieces();
    }
    // used to get the alliance of the white player(i.e. color of the piece)
    @Override
    public Alliance getAlliance() {
        return Alliance.WHITE;
    }
    // used to get representation of the white player in string format
    @Override
