...
class GameHistoryPanel extends JPanel {
    ...
    // representing the check and checkmate in history table
    ...
    // used to create the game history table
    private static class DataModel extends DefaultTableModel {
        ...
        // used to retrive the moves back from the history table
        @Override
        ...
        // used to insert the moves into the history table
        @Override
