...
public final class Table extends Observable {
    ...
    private Table() {
        ...
        this.useBook = false;
        this.pieceIconPath = "Chess_Engine/art/holywarriors/";
    ...
    private JMenu createOptionsMenu() {
        ...
        // used to print the details of the current state 
        // of the board and the players information
        ...
        // used to undo the move that has last made
        ...
        // used to setup the ai and human player 
        // for black and white player
    ...
    private JMenu createPreferencesMenu() {
        ...
        holyWarriorsMenuItem.addActionListener(e -> {
            pieceIconPath = "Chess_Engine/art/holywarriors/";
            Table.get().getBoardPanel().drawBoard(chessBoard);
        });
        fancyMenMenuItem2.addActionListener(e -> {
            pieceIconPath = "Chess_Engine/art/fancy2/";
            Table.get().getBoardPanel().drawBoard(chessBoard);
        });
        fancyMenMenuItem.addActionListener(e -> {
            pieceIconPath = "Chess_Engine/art/fancy/";
            Table.get().getBoardPanel().drawBoard(chessBoard);
        });
    ...
    // used to set up the new standard board for the new game
    ...
    // used to undo the last move for the undo button action
    ...
    // used to represent the board GUI 
    ...
    // used to represent the direction of the board
    enum BoardDirection {
        NORMAL {
            @Override
    ...
    // used to record the move history
            ...
            if (Table.get().getHighlightLegalMoves()) {
                for (final Move move : pieceLegalMoves(board)) {
                    if (move.getDestinationCoordinate() == this.tileId) {
                        try {
                            add(new JLabel(new ImageIcon(ImageIO.read(new File("Chess_Engine/art/misc/green_dot.png")))));
                        }
